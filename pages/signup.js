      ...
      <div className="min-h-screen bg-[#0f1e3c] text-white flex items-center justify-center px-4">
        <div className="max-w-lg w-full p-6">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <textarea value={description} onChange={(e) => setDescription(e.target.value)} required placeholder="Descrizione" className="w-full px-3 py-2 rounded bg-gray-700 text-white" rows={3} />
