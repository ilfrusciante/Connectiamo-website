      ...
      <div className="max-w-lg w-full p-6">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div>
            ...
            <input type="text" value={nome} onChange={(e) => setNome(e.target.value)} required className="w-full px-3 py-2 rounded bg-gray-700 text-white" />
          </div>

          <div>
            <label className="block text-sm mb-1">Cognome</label>
            <input type="text" value={cognome} onChange={(e) => setCognome(e.target.value)} required className="w-full px-3 py-2 rounded bg-gray-700 text-white" />
          </div>

          <div>
            <label className="block text-sm mb-1">Nickname</label>
            <input type="text" value={nickname} onChange={(e) => setNickname(e.target.value)} required className="w-full px-3 py-2 rounded bg-gray-700 text-white" />
          </div>

          <div>
            <label className="block text-sm mb-1">Email</label>
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="w-full px-3 py-2 rounded bg-gray-700 text-white" />
          </div>

          <div>
            <label className="block text-sm mb-1">Password</label>
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="w-full px-3 py-2 rounded bg-gray-700 text-white" />
          </div>
          ...
          <div className="flex space-x-4">
            <div className="w-2/3">
              ...
              <input type="text" value={city} onChange={(e) => setCity(e.target.value)} required className="w-full px-3 py-2 rounded bg-gray-700 text-white" />
            </div>
            <div className="w-1/3">
              <label className="block text-sm mb-1">CAP</label>
              <input type="text" value={cap} onChange={(e) => setCap(e.target.value)} required className="w-full px-3 py-2 rounded bg-gray-700 text-white" />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Scrivi una breve descrizione del tuo profilo o dei tuoi contatti..." className="w-full px-3 py-2 rounded bg-gray-700 text-white" rows={3}></textarea>
          </div>
