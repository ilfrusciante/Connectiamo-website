// pages/chat.js import { useEffect, useState } from 'react'; import { supabase } from '../utils/supabaseClient';
...
if (selectedUser.id.startsWith('f')) {
  setTimeout(() => {
    const reply = {
      ...
      receiver_id: user ? user.id : 'me',
      content: 'Grazie per il messaggio! Ti risponderò presto.',
    };
