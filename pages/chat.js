import { useEffect, useState } from 'react'; import { useRouter } from 'next/router'; import { supabase } from '../utils/supabaseClient'; import dayjs from 'dayjs'; import Link from 'next/link'; import Navbar from '../components/Navbar';
...
return ( <> <Navbar /> <div className="min-h-screen bg-[#0f1e3c] text-white p-4"> <div className="flex items-center justify-between mb-4"> <Link href="/messages"> <a className="text-yellow-400 text-sm underline hover:text-yellow-500">Torna ai contatti</a> </Link> </div>
              ...
              <div
                ...
                className={`mb-3 max-w-[80%] px-4 py-2 rounded-2xl text-sm shadow-md ${
                  msg.sender_id === user.id
                    ? 'bg-[#f3cd4d]/80 text-black ml-auto'
