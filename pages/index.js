        ...
        <section className="bg-blue-800 text-white py-16 px-6 md:px-20">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="md:w-1/2 mt-10 md:mt-0 flex justify-center">
              <Image
                src="/images/connect-hero.png" // ← la tua immagine
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow text-center">
                ...
                <p className="text-gray-600">Crea un profilo come segnalatore o professionista</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow text-center">
                ...
                <p className="text-gray-600">Usa la nostra ricerca per trovare persone nella tua zona e categoria</p>
              </div>

              {/* Step 3 */}
              <div className="bg-white p-6 rounded-xl shadow text-center">
                <Image src="/images/step3-connetti.png" alt="Connetti" width={64} height={64} className="mx-auto mb-4" />
                <h3 className="text-lg font-semibold mb-2">3 Connettiti</h3>
                <p className="text-gray-600">Metti in contatto tramite messaggistica privata</p>
              </div>
